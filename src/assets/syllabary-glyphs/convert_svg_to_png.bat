...
set SVG_FOLDER=C:\programming\poem-generator-electron\src\assets\svg - Copy
set PNG_FOLDER=C:\programming\poem-generator-electron\src\assets\svg - Copy
...
for %%f in ("%SVG_FOLDER%\*.svg") do (
    ...
    "%INKSCAPE_PATH%" --export-type=png --export-filename="!full_output_name!" --export-area-drawing "%%f"
